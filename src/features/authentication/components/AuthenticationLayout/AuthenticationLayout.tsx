        ...
        <div className={classes.container}>
          <a href="/" className={classes.logoLink}>
            <div className={classes.logoContainer}>
              <div className={classes.logoIcon}>O</div>
              <span className={classes.brandName}>Opportune</span>
            </div>
          </a>
        </div>
      </header>
      ...
      <footer className={classes.footer}>
        <div className={classes.container}>
          <ul className={classes.footerList}>
            <li className={classes.brandSection}>
              <div className={classes.footerLogoIcon}>O</div>
              <span className={classes.brandText}>Opportune</span>
              <span className={classes.copyright}>© 2024</span>
            </li>
            <li>
